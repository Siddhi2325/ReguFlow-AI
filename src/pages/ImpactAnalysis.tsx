...
export default function ImpactAnalysis() {
  ...
  useEffect(() => {
    ...
    api.impact(selectedCompId)
      ...
      .catch((err) => {
        if (userType === "department_officer" && err.message?.includes("Access Denied")) {
          toast({
            title: "Impact Analysis Not Generated",
            description: "The Operational Impact Analysis has not been generated for this circular yet. Please ask an AI Compliance Officer to run the analysis.",
            variant: "default"
          });
        } else {
      ...
      <div className="space-y-6 animate-fade-in-up">
        ...
        <EmptyState 
          ...
          description={userType === "department_officer"
            ? "No active impact assessments have been generated by your AI Compliance Officer yet."
